...
UPLOAD_PATH_DOCS = os.path.join(UPLOAD_PATH, 'documentos/')

# RECAPTCH
RECAPTCHA_PUBLIC_KEY = '6LdfMQkAAAAAAHY7kjwFESUXfX3lLFFupveH0Caa'
RECAPTCHA_PRIVATE_KEY = '6LdfMQkAAAAAAFJx9PxaFGqh3MbHFjJg77kBd6Oe'
...
if not os.path.exists(UPLOAD_PATH_DOCS):
    os.makedirs(UPLOAD_PATH_DOCS)
